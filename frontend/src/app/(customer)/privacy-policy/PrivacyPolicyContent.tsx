...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      {/* Layout */}
      <div className="privacy-layout" style={{ maxWidth: "1500px", margin: "0 auto", padding: "40px 24px", display: "grid", gridTemplateColumns: "200px 1fr", gap: "32px", alignItems: "start" }}>
        ...
        <div className="privacy-sidebar" style={{ position: "sticky", top: "24px" }}>
          <div style={{ background: "#F7F8FA", border: "1px solid #E5E7EB", borderRadius: "6px", overflow: "hidden" }}>
            ...
            <a href="/contact" style={{ display: "block", padding: "12px 16px", fontSize: "13px", color: "#7A7880", textDecoration: "none", borderBottom: "1px solid #E5E7EB" }}>Contact Support</a>
            <a href="/track-order" style={{ display: "block", padding: "12px 16px", fontSize: "13px", color: "#7A7880", textDecoration: "none" }}>Track My Order</a>
          </div>
        </div>
        ...
        <div>
          ...
          {active === "shipping" && (
            <div>
              ...
              <div style={{ fontSize: "11px", color: "#7A7880", fontWeight: 600, marginBottom: "20px" }}>Last updated: January 2025</div>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "24px" }}>Orders are shipped via USPS/UPS / FedEx / OnTrac ground or a preferred carrier unless otherwise indicated at the time the order is placed. If you would like to use your own UPS or FedEx account, please include the information at the time of ordering.</p>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "20px" }}>Please inspect all merchandise before washing, printing or any alterations. We cannot accept returns or exchanges that have been altered in any way. All claims must be made within 5 days of receipt of goods and must be submitted by e-mail to info@afblanks.com. All returned merchandise will be refused if not accompanied with a Return Authorization and are subject to a 10% restocking fee. Customers will be responsible for shipping costs on all returned items that AF Apparels is not at fault for.</p>

              <div style={{ background: "#F7F8FA", border: "1px solid #E5E7EB", borderRadius: "6px", padding: "16px", fontSize: "13px", color: "#7A7880", lineHeight: 1.8 }}>
          ...
          {active === "ordering" && (
            <div>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>All purchases through AF Apparels require an approved wholesale business account. Account applications are reviewed within 24 business hours. Once approved, you have immediate access to wholesale pricing and the full product catalog.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>To apply, complete the account application form. You will need your business name, contact information, business type, and an estimate of your monthly volume. There is no fee to apply and no minimum purchase commitment required.</p>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={t} style={{ borderBottom: "1px solid #F3F4F6" }}>
                      ...
                      <td style={{ padding: "10px 14px", color: "#7A7880" }}>{m}</td>
                      <td style={{ padding: "10px 14px", color: "#7A7880" }}>{n}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>AF Apparels pricing is tiered based on the total quantity in your cart. Volume discounts apply automatically — no coupon codes or negotiations required. Your per-unit price updates in real-time as you add quantities to your order. The tier structure is backend pricing logic and is not displayed in the interface.</p>

              <h3 style={{ fontFamily: "var(--font-bebas)", fontSize: "16px", letterSpacing: ".04em", color: "#111", margin: "20px 0 10px" }}>Placing Orders</h3>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>Once logged in, use the Bulk Order Grid on each product page to select colors and enter quantities per size. The grid displays real-time stock counts for each size per color. Add your completed order to cart, review the cart summary, and proceed to checkout.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>For large orders (over 1,000 units) or custom configurations, you can use the &ldquo;Request a Quote&rdquo; option on any product page. Our sales team will respond within 2 business hours with pricing and availability confirmation.</p>

              <h3 style={{ fontFamily: "var(--font-bebas)", fontSize: "16px", letterSpacing: ".04em", color: "#111", margin: "20px 0 10px" }}>Order Confirmation</h3>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>You will receive an order confirmation email immediately after checkout. Review this confirmation carefully — it reflects the exact quantities, colors, and sizes ordered. Report any discrepancies to info@afblanks.com within 24 hours of receiving the confirmation.</p>
          ...
          {active === "terms" && (
            <div>
              ...
              <div style={{ fontSize: "11px", color: "#7A7880", fontWeight: 600, marginBottom: "20px" }}>Terms of service</div>
              ...
              {TERMS_FAQS.map((item, i) => (
                <div key={i}>
                  ...
                  {item.multi
                    ? item.multi.map((p, j) => <p key={j} style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>{p}</p>)
                    : <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>{item.body}</p>
                  }
                </div>
              ))}
            </div>
          ...
          {active === "privacy" && (
            <div>
              ...
              <div style={{ fontSize: "11px", color: "#7A7880", fontWeight: 600, marginBottom: "20px" }}>Last updated: January 30, 2025</div>

              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>This Privacy Policy describes how AF Apparels Retail (the &ldquo;Site&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from retail.afapparels.com (the &ldquo;Site&rdquo;) or otherwise communicate with us regarding the Site (collectively, the &ldquo;Services&rdquo;). For purposes of this Privacy Policy, &ldquo;you&rdquo; and &ldquo;your&rdquo; means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>Please read this Privacy Policy carefully. By using and accessing any of the Services, you agree to the collection, use, and disclosure of your information as described in this Privacy Policy. If you do not agree to this Privacy Policy, please do not use or access any of the Services.</p>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>In addition to the specific uses set out below, we may use information we collect about you to communicate with you, provide or improve the Services, comply with any applicable legal obligations, enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.</p>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term &ldquo;personal information&rdquo;, we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.</p>

              <h4 style={{ fontSize: "13px", fontWeight: 700, color: "#111", marginBottom: "8px" }}>Information We Collect Directly from You</h4>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "8px" }}>Information that you directly submit to us through our Services may include:</p>
              <ul style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, paddingLeft: "20px", marginBottom: "16px" }}>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>Some features of the Services may require you to directly provide us with certain information about yourself. You may elect not to provide this information, but doing so may prevent you from using or accessing these features.</p>

              <h4 style={{ fontSize: "13px", fontWeight: 700, color: "#111", marginBottom: "8px" }}>Information We Collect about Your Usage</h4>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>We may also automatically collect certain information about your interaction with the Services (&ldquo;Usage Data&rdquo;). To do this, we may use cookies, pixels and similar technologies (&ldquo;Cookies&rdquo;). Usage Data may include information about how you access and use our Site and your account, including device information, browser information, information about your network connection, your IP address and other information regarding your interaction with the Services.</p>

              <h4 style={{ fontSize: "13px", fontWeight: 700, color: "#111", marginBottom: "8px" }}>Information We Obtain from Third Parties</h4>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "8px" }}>Finally, we may obtain information about you from third parties, including from vendors and service providers who may collect information on our behalf, such as:</p>
              <ul style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, paddingLeft: "20px", marginBottom: "12px" }}>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>When you visit our Site, open or click on emails we send you, or interact with our Services or advertisements, we, or third parties we work with, may automatically collect certain information using online tracking technologies such as pixels, web beacons, software developer kits, third-party libraries, and cookies. Any information we obtain from third parties will be treated in accordance with this Privacy Policy.</p>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>Like many websites, we use Cookies on our Site. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services. We may also permit third parties and service providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "12px" }}>Most browsers automatically accept Cookies by default, but you can choose to set your browser to remove or reject Cookies through your browser controls. Please keep in mind that removing or blocking Cookies can negatively impact your user experience and may cause some of the Services, including certain features and general functionality, to work incorrectly or no longer be available.</p>
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>Our website also recognizes the Global Privacy Control (GPC) signal, which enables you to opt-out of certain uses or disclosures of your information.</p>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "8px" }}>In certain circumstances, we may disclose your personal information to third parties for contract fulfillment purposes, legitimate purposes and other reasons subject to this Privacy Policy. Such circumstances may include:</p>
              <ul style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, paddingLeft: "20px", marginBottom: "16px" }}>
              ...
              <p style={{ fontSize: "13px", color: "#7A7880", lineHeight: 1.7, marginBottom: "16px" }}>We do not use or disclose sensitive personal information without your consent or for the purposes of inferring characteristics about you. We have &ldquo;sold&rdquo; and &ldquo;shared&rdquo; personal information over the preceding 12 months for the purpose of engaging in advertising and marketing activities with business and marketing partners.</p>
