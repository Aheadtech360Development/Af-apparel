...
const SHIPPING_OPTIONS: { id: ShippingMethod; label: string; sub: string; price: string; note?: string }[] = [
  {
    ...
    sub: "3–5 business days · Ships from Dallas, TX",
    price: "FREE",
  ...
  },
  {
    ...
    sub: "2 business days — guaranteed delivery",
    price: "$45.00",
  },
  {
    id: "freight",
    label: "Freight / LTL",
    sub: "For pallet-size orders — quote provided after checkout",
    price: "Quoted",
  },
];
...
export default function CheckoutAddressPage() {
  ...
  function handleContinue() {
    ...
    setAddressId(null); // using inline address
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
                    ...
                    <span style={{
                      ...
                      color: priceDisplay === "FREE" ? "#059669" : "#2A2830",
                    }}>
                      {priceDisplay}
                    </span>
                  </div>
